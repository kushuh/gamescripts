...
if not exist "%~dp0Read-Secret-Missions.ps1" goto missingReader
"%SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe" -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%~dp0Read-Secret-Missions.ps1"
...
goto finish
:missingReader
echo Keep Read-Secret-Missions.ps1 in the same folder as this launcher.
set "vesperiaExitCode=1"
:finish
echo(
